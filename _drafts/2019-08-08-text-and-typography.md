...
<!-- markdownlint-capture -->
<!-- markdownlint-disable -->
> An example showing the `tip` type note.
{: .note-tip }

> An example showing the `info` type note.
{: .note-info }

> An example showing the `warning` type note.
{: .note-warning }

> An example showing the `danger` type note.
{: .note-danger }
<!-- markdownlint-restore -->
