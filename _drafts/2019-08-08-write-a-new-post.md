...
There are several types of prompts: `tip`, `info`, `warning`, and `danger`. They can be generated by adding the class `note-{type}` to the blockquote. For example, define a prompt of type `info` as follows:
